...
# mymodelpath = /data/models/Mistral-Nemo-Instruct-12B
mymodelpath = 'meta-llama/Llama-3.3-70B-Instruct'
...
async def generate_tool_query(request_id: str, user_messages: List[Message], tools: List[Tool]) -> tuple[str, str]:
    ...
    Formats the prompt differently based on model type (Mistral or Llama).
